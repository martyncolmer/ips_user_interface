...
def dashboard_view():
    ...
    header = ['Run_ID', 'Run_Name', 'Run_Description', 'Period', 'Year', 'Modified', 'User', 'Status']
    ...
    for record in records:
        ...
        record['LAST_MODIFIED'] = datetime.utcfromtimestamp(record['LAST_MODIFIED']/1000).strftime('%Y-%m-%d %H:%M:%S')
